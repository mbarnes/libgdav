...
static void
gdav_getcontentlength_property_class_init (GDavGetContentLengthPropertyClass *class)
{
...
static void
gdav_getcontentlength_property_init (GDavGetContentLengthProperty *property)
{
}
