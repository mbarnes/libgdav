...
static void
gdav_getcontentlanguage_property_class_init (GDavGetContentLanguagePropertyClass *class)
{
...
static void
gdav_getcontentlanguage_property_init (GDavGetContentLanguageProperty *property)
{
}
