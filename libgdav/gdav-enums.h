...
typedef enum { /*< flags >*/
	...
	GDAV_RESOURCE_TYPE_CALENDAR = 1 << 2,
	GDAV_RESOURCE_TYPE_SCHEDULE_INBOX = 1 << 3,
	GDAV_RESOURCE_TYPE_SCHEDULE_OUTBOX = 1 << 4,
	GDAV_RESOURCE_TYPE_ADDRESSBOOK = 1 << 5,
	GDAV_RESOURCE_TYPE_MOUNTPOINT = 1 << 6
} GDavResourceType;
